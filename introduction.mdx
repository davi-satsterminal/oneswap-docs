...
<Note>
  **Availability.** Swaps are live on OneSwap **devnet** and **mainnet**. All you need is an SDK
  API key (`sk_live_...`) from your OneSwap account — [swap.oneswap.cc](https://swap.oneswap.cc)
  (mainnet) or [devnet.oneswap.cc](https://devnet.oneswap.cc) (devnet); see
  [API keys](/guides/api-keys). Market data and quotes are read-only and available on both
  networks.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Trader SDK" icon="chart-line" href="/guides/trader-sdk">
